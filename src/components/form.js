    ...
    return(
        <div className="p-3 align-items-end">
            <fieldset className="position-relative">
                ...
                <button className="position-absolute end-30 btn border border-white text-secondary" type="button">
                ...
                <button className="position-absolute end-45 btn border border-white text-secondary" type="button">
