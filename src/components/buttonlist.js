        ...
        <div className="row">
            <div className="col">
                ...
                <ul className="flex-column">
                    <li className="d-flex">
                        <div className="d-flex justify-content-around align-items-center border-white btn btn-lg btn-outline-primary rounded-4 w-100">
                    ...
                    <li className="d-flex">
                        <div className="d-flex justify-content-around align-items-center border-white btn btn-lg btn-outline-primary rounded-4 w-100">
                            ...
                            <p className="pt-4">Analytics</p>
                        </div>
                    </li>
                    <li className="d-flex">
                        <div className="d-flex justify-content-around align-items-center border-white btn btn-lg btn-outline-primary rounded-4 w-100">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-folder2" viewBox="0 0 16 16">
